<template>
    <footer
        class="fixed bottom-0 left-0 z-20 w-full p-4 bg-slate-800 border-t border-lime-500 shadow md:flex md:items-center md:justify-between md:p-6  dark:border-indigo-500">
        <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">
            <a href="/"
                class="hover:text-lime-500 dark:hover:text-indigo-500 text-gray-400 dark:text-gray-400 ">Покраска в
                городе Казань </a>
            <ULink to="tel:+79372979997" active-class="text-lime-500 dark:text-indigo-500 "
                inactive-class="hidden text-green-500 text-hidden md:inline font-semibold text-gray-500 dark:text-green-500 hover:text-lime-500 dark:hover:text-indigo-500">
                +7 937 297 99 97
            </ULink>
        </span>
        ...
        <div>
            ...
            <UButton to="https://wa.me/79372979997" icon="i-mdi-whatsapp" size="sm" color="lime" square
                variant="link" />
            <UButton to="https://t.me/+79372979997" icon="i-mdi-telegram" size="sm" color="lime" square
                variant="link" />
        </div>
        ...
        <div
            ...
            <ULink to="galery" active-class="text-lime-500 dark:text-indigo-500"
                inactive-class="font-semibold text-gray-500 dark:text-gray-400 hover:text-lime-500 dark:hover:text-indigo-500">
                Галерея
            </ULink>
            <ULink to="contacts" active-class="text-lime-500 dark:text-indigo-500"
                inactive-class="font-semibold text-gray-500 dark:text-gray-400 hover:text-lime-500 dark:hover:text-indigo-500">
                Контакты
            </ULink>
        </div>
